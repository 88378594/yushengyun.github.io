<template>
  <div class="wallpaper_box">
    ...
    <div class="bottom">
      <i
        @click="switchTo(1)"
        :class="{ i_a: title == '首页', i_b: title != '首页' }"
        class="iconfont icon-zhuye"
      ></i>
      <i
        @click="switchTo(2)"
        :class="{ i_a: title == '分类', i_b: title != '分类' }"
        class="iconfont icon-icon"
      ></i>
      <i
        @click="switchTo(3)"
        :class="{ i_a: title == '我的', i_b: title != '我的' }"
...
export default {
  ...
  methods: {
    ...
    switchTo(i) {
      switch (i) {
        case 1:
          sessionStorage.setItem("title","首页")
          this.title = "首页";
          break;
        case 2:
          sessionStorage.setItem("title","分类")
          this.title = "分类";
          break;
        case 3:
          sessionStorage.setItem("title","我的")
          this.title = "我的";
          break;
      }
    },
